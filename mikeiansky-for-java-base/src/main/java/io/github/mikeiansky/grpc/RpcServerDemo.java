...
public class RpcServerDemo {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        final RpcServerDemo serverDemo = new RpcServerDemo();
        //启动server
        serverDemo.start();
        //block 一直到退出程序
    ...
    static class HelloImpl extends HelloServiceGrpc.HelloServiceImplBase {
        ...
        public void sayHello(HelloRequest request, StreamObserver<HelloResponse> responseObserver) {
            ...
            System.out.println("request name is : " + requestName);
            HelloResponse reply = HelloResponse.newBuilder().setMessage("(server端的sayHello()方法处理结果) Hello," + request.getName()).build();
