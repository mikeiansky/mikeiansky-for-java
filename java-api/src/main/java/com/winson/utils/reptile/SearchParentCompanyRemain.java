 ...
 * @date 2021/9/23
 **/
public class SearchParentCompanyRemain {
    ...
    public static final String outPath = "D:\\work\\temp\\out\\out-remain.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filePath = "D:\\work\\temp\\bas_company.xlsx";
...
//        int size = 18772;
        ...
        for (int i = from; i < size; i++) {
            ...
            if (fullNameCell != null) {
                ...
                try {
                    // TODO
                    int cfn = (int) Float.parseFloat(company.companyFullName);
                    company.companyFullName = String.valueOf(cfn);
                } catch (Exception e) {
                }
