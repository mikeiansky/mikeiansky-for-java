...
public class MinorGCDemo {
    ...
    /**
     *  VM参数：-XX:+UseSerialGC -Xms20M -Xmx20M -Xmn10M -XX:+PrintGCDetails -XX:SurvivorRatio=8 -XX:-HandlePromotionFailure
     *
     *  -XX:-PromotionFailureALot // VM option 'PromotionFailureALot' is notproduct and is available only in debug version of VM.
     */
    @SuppressWarnings("unused")
